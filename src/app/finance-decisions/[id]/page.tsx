...
import { createRecoveryPlanDraft, recoveryPlanFromFinanceDecision } from "@/lib/decisionSimulator";
...
function FinanceDecisionDetail({ id, uid }: { id: string; uid: string }) {
  ...
  async function createRecovery() {
    ...
    setBusy("recovery");
    try {
      const result = await createRecoveryPlanDraft(getClientDb(), recoveryPlanFromFinanceDecision(uid, decision));
      setRecoveryPlanId(result.recoveryPlanId);
    } finally {
      setBusy(null);
    }
  }
