...
function ReviewQueueData({ uid }: { uid: string }) {
  ...
  const sources = [tasks, financeDecisions, financeDecisionReviews, investments, allocations, financeReviews, reports, jobs, sops, creditCards, profiles, expenseSignals, briefs];
