...
import { createRecoveryPlanDraft, recoveryPlanFromInvestmentDecision } from "@/lib/decisionSimulator";
...
function InvestmentDetail({ id, uid }: { id: string; uid: string }) {
  ...
  async function createRecovery() {
    ...
    setBusy("recovery");
    try {
      const result = await createRecoveryPlanDraft(getClientDb(), recoveryPlanFromInvestmentDecision(uid, investment));
