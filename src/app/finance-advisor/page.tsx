...
function FinanceAdvisorData({ uid }: { uid: string }) {
  ...
  return (
    <div className="grid">
      ...
      <section className="panel"><h2>Finance Decision Intelligence</h2><div className="action-row"><Link className="button compact" href="/finance-decisions">重大財務決策</Link><Link className="button secondary compact" href="/expense-signals">警訊支出累積</Link><Link className="button secondary compact" href="/investment-decisions">投資決策</Link><Link className="button secondary compact" href="/expense-signals">信用卡與分期</Link></div></section>
